...
(function () {
  ...
  const ARTICLES = [
    ...
    { url: '/journal/vodka-styles-explained/',                    title: 'Vodka styles explained',                       cat: 'spirits' },
    { url: '/journal/gin-botanicals-deep-dive/',                  title: 'Gin botanicals deep dive',                     cat: 'spirits' },
    { url: '/journal/world-rums-by-country/',                     title: 'World rums by country',                        cat: 'spirits' },
    { url: '/journal/mezcal-styles-explained/',                   title: 'Mezcal styles explained',                      cat: 'spirits' },
    { url: '/journal/tonic-water-explained/',                     title: 'Tonic water explained',                        cat: 'spirits' },
    { url: '/journal/alcohol-free-amaro/',                        title: 'Alcohol-free amaro',                           cat: 'zero' },
    { url: '/journal/na-spritz-template/',                        title: 'The NA spritz template',                       cat: 'zero' },
    { url: '/journal/na-old-fashioned/',                          title: 'The NA Old Fashioned',                         cat: 'zero' },
    { url: '/journal/jasmine-tea-cocktails/',                     title: 'Jasmine tea cocktails',                        cat: 'malaysian' },
    { url: '/journal/masala-chai-cocktails/',                     title: 'Masala chai cocktails',                        cat: 'malaysian' },
    { url: '/journal/oolong-cocktails/',                          title: 'Oolong tea cocktails',                         cat: 'malaysian' },
    { url: '/journal/aeropress-cocktails/',                       title: 'AeroPress for cocktails',                      cat: 'technique' },
    { url: '/journal/coffee-tasting-vocabulary/',                 title: 'Coffee tasting vocabulary',                    cat: 'practical' },
    { url: '/journal/siphon-coffee-cocktails/',                   title: 'Siphon coffee for cocktails',                  cat: 'technique' },
    { url: '/journal/kombucha-second-fermentation/',              title: 'Kombucha second fermentation',                 cat: 'ferment' },
    { url: '/journal/ginger-bug-cordials/',                       title: 'Ginger bug cordials',                          cat: 'ferment' },
